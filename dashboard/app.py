...
# ================================================================
# PALETTE & STYLE - Couleurs améliorées
# ================================================================
# Palette de couleurs modernes et harmonieuses
PALETTE = ["#1E88E5", "#FF6F00", "#43A047", "#E53935", "#8E24AA", "#FB8C00", "#00ACC1", "#D81B60"]
PALETTE_DIVERGENTE = ["#1E88E5", "#FF6F00"]
...
if page == "Tableau de bord":
    ...
    if len(df_volume):
        ...
        fig1.update_traces(line=dict(width=3), fillcolor="rgba(30, 136, 229, 0.15)")
